...
def compute_avg_monthly_difference(time_series, first_year, last_year):
    ...
    for i in range (len(time_series)):
        ...
        anno_mese_seguente = time_series[i+1][0] #assegno alla variabile il valore dello seguente elemento della lista
        ...
        if anno_mese[0] == first_year:
            ...
            try:
                time_series[i][1] = int(time_series[i][1]) 
        ...
        if time_series[i+12][1] != 0 and time_series[i][1] != 0: 
            ...
            lista_risultato[anno_mese[1]-1] += (time_series[i+12][1] - time_series[i][1])/diff_first_last #aggiungo alla lista il num dei passegeri di quel mese
